...
\tcode{regex_traits<wchar_t>} \changed{shall be}{are} valid and \removed{shall} satisfy the
...
\added{\expects \range{p}{p+char_traits<charT>::length(p)} is a valid range.}
...
\begin{itemdescr}
\pnum
\changed{\requires}{\expects} \tcode{ptr} \changed{shall not be}{is not} a null pointer.
...
\begin{itemdescr}
\pnum
\changed{\requires}{\expects} \tcode{ready() == true} and \tcode{OutputIter} \changed{shall satisfy}{meets} the requirements for a
...
\pnum
\changed{\requires}{\expects}
\removed{The type} \tcode{BidirectionalIterator} \changed{shall satisfy}{meets} the
...
\pnum
\changed{\requires}{\expects}
\removed{Type} \tcode{BidirectionalIterator} \changed{shall satisfy}{meets} the
\oldconcept{BidirectionalIterator} requirements\iref{bidirectional.iterators}.
