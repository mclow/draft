...
\tcode{regex_traits<wchar_t>} \changed{shall be}{are} valid and \changed{shall meet}{meets} the
...
\pnum
\effects  \removed{Constructs an object of class \tcode{basic_regex};} the object's
...
\ednote Do we even need this requirement? We get it from the call to \tcode{assign}
