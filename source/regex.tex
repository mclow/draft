...
\pnum
\effects \changed{Returns}{Equivalent to:} \tcode{\added{return} assign(ptr)}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\effects \changed{Returns}{Equivalent to:} \tcode{\added{return} assign(il.begin(), il.end())}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\effects \changed{Returns}{Equivalent to:} \tcode{\added{return} assign(p)}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\changed{\returns}{\effects Equivalent to:} \tcode{\added{return} assign(string_type(ptr), f)}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\changed{\returns}{\effects Equivalent to:} \tcode{\added{return} assign(string_type(ptr, len), f)}.
\end{itemdescr}
...
\pnum
\effects \changed{Returns}{Equivalent to:} \tcode{\added{return} assign(string_type(first, last), f)}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\effects \changed{Same as}{Equivlent to:} \tcode{\added{return} assign(il.begin(), il.end(), f)}.
...
\pnum
\effects
\changed{Move constructs an object of class \tcode{match_results} from \tcode{m} satisfying the same postconditions as}
        {The postconditions of this function are indicated in} \tref{re.results.const}.
\changed{Additionally, the}{The} stored \tcode{Allocator} value is move constructed from \tcode{m.get_allocator()}.
...
\begin{itemdescr}
\pnum
\effects \removed{Assigns \tcode{m} to \tcode{*this}.} The postconditions of this
...
\begin{itemdescr}
\pnum
\effects\ \removed{Move-assigns \tcode{m} to \tcode{*this}.} The postconditions of this function
