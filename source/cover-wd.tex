...
Also, (Thanks Tim!) a few places that said "\tcode{...::propagate_on_container_move_assignment} is true" now say "\tcode{...::propagate_on_container_move_assignment::value} is true"
