...
\begin{center}
\textbf{\Huge
Mandating the Standard Library:\\Clause 19 - Utilities library}
\end{center}
...
As a drive-by fix, a couple of places that said "The constructor of Foo constructs an object of class Foo" have been removed.
