...
\begin{itemdescr}
\pnum
\removed{If \tcode{N} is negative the program is ill-formed.}
\added{\mandates \tcode{N >= 0}.} The alias template
...
\added{%
\pnum
\constraints \tcode{is_swappable_v<$\tcode{T}_i$>} is \tcode{true}
