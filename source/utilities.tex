...
\begin{itemdescr}
\pnum
\begin{removedblock}\remarks This function
...
\begin{addedblock}\remarks This function
...
unless}{\constraints} \tcode{is_swappable_v<T>} is \tcode{true}.
...
\remarks
\begin{removedblock} This constructor shall not participate in overload resolution unless
...
with default template arguments. \end{note}\end{removedblock}
...
\pnum
\remarks \removed{This constructor shall not participate in overload resolution
...
\pnum
\remarks \removed{This constructor shall not participate in overload resolution unless
...
\pnum
\removed{\remarks This operator shall be defined as deleted unless
...
\pnum
\begin{removedblock}\remarks This operator shall not participate in overload resolution unless
...
\end{codeblock}\end{removedblock}

\pnum
\returns \tcode{*this}.

\begin{addedblock}\remarks The expression inside \tcode{noexcept} is equivalent to:
\begin{codeblock}
is_nothrow_move_assignable_v<T1> && is_nothrow_move_assignable_v<T2>
...
\begin{itemdescr}
\pnum
\changed{\remarks}{\expects} All specializations of \tcode{tuple_size} shall meet the
...
\changed{shall have}{has} well-defined behavior, and \changed{shall}{does} not throw exceptions. \begin{note} The
...
\pnum
\requires If \tcode{D} is not a reference type, \tcode{D} \changed{shall meet}{meets} the
...
\pnum
\changed{\requires}{\expects}
The \tcode{order} argument \changed{shall not be}{is neither}
...
\pnum
\changed{\requires}{\expects}
\tcode{order} \changed{shall not be}{is neither}
...
\pnum
\changed{\requires}{\expects}
\tcode{failure} \changed{shall not be}{is neither}
\tcode{memory_order::release} nor \tcode{memory_order::acq_rel}.
