...
\pnum
\effects
\changed{As if by}{Equivalent to}: \added{return }\tcode{os << ec.category().name() << ':' << ec.value();}
\end{itemdescr}
...
\added{\pnum \constraints \tcode{is_error_condition_enum_v<ErrorConditionEnum>} is \tcode{true}.}
