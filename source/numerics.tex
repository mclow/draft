...
\begin{itemdescr}
\pnum\effects \removed{Constructs a \tcode{random_device}
...
\pnum\changed{\requires}{\expects}
  ...
  the expression
  \tcode{*dest = rt}
  \changed{shall be}{is} valid for a value \tcode{rt} of type \tcode{result_type}.
...
\pnum\effects \removed{Constructs a \tcode{uniform_int_distribution} object;}
 \tcode{a} and \tcode{b}
...
\pnum\effects \removed{Constructs a \tcode{uniform_real_distribution} object;}
 \tcode{a} and \tcode{b}
 correspond to the respective parameters of the distribution.
\end{itemdescr}
...
\pnum\effects \removed{Constructs a \tcode{bernoulli_distribution} object;}
 \tcode{p}
...
\pnum\effects \removed{Constructs a \tcode{binomial_distribution} object;}
 \tcode{t} and \tcode{p}
 correspond to the respective parameters of the distribution.
\end{itemdescr}
...
\pnum\effects \removed{Constructs a \tcode{geometric_distribution} object;}
 \tcode{p}
 corresponds to the parameter of the distribution.
\end{itemdescr}
...
\pnum\effects \removed{Constructs a \tcode{negative_binomial_distribution} object;}
 \tcode{k} and \tcode{p}
 correspond to the respective parameters of the distribution.
\end{itemdescr}
...
\pnum
\effects \removed{Constructs a \tcode{poisson_distribution} object;}
...
\pnum
\effects \removed{Constructs an \tcode{exponential_distribution} object;}
...
\pnum
\effects \removed{Constructs a \tcode{gamma_distribution} object;}
...
\pnum
\effects \removed{Constructs a \tcode{weibull_distribution} object;}
\tcode{a} and \tcode{b}
correspond to the respective parameters of the distribution.
\end{itemdescr}
...
\pnum
\effects \removed{Constructs an \tcode{extreme_value_distribution} object;}
\tcode{a} and \tcode{b}
correspond to the respective parameters of the distribution.
\end{itemdescr}
...
\pnum
\effects \removed{Constructs a \tcode{normal_distribution} object;}
...
\pnum
\effects \removed{Constructs a \tcode{lognormal_distribution} object;}
\tcode{m} and \tcode{s}
correspond to the respective parameters of the distribution.
\end{itemdescr}
...
\pnum
\effects \removed{Constructs a \tcode{chi_squared_distribution} object;}
...
\pnum
\effects \removed{Constructs a \tcode{cauchy_distribution} object;}
\tcode{a} and \tcode{b}
correspond to the respective parameters of the distribution.
\end{itemdescr}
...
\pnum
\effects \removed{Constructs a \tcode{fisher_f_distribution} object;}
\tcode{m} and \tcode{n}
correspond to the respective parameters of the distribution.
\end{itemdescr}
...
\pnum
\effects \removed{Constructs a \tcode{student_t_distribution} object;}
\tcode{n} corresponds to the parameter of the distribution.
\end{itemdescr}
...
\mandates
\begin{itemize}
\item{\tcode{UnaryOperation} is a function object\iref{function.objects} whose return type is convertible to \tcode{double}.}
\item{\tcode{double} is convertible to the type of \tcode{UnaryOperation}'s sole parameter.}
\end{itemize}
\end{addedblock}
...
\begin{addedblock}
\pnum
\expects \tcode{[p, p + n)} is a valid range.
\end{addedblock}
