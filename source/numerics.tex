...
\begin{itemdescr}
\pnum\effects \removed{Constructs a \tcode{linear_congruential_engine} object.}
...
\begin{itemdescr}
\pnum\effects \removed{Constructs a \tcode{mersenne_twister_engine} object.}
...
\begin{itemdescr}
\pnum\effects \removed{Constructs a \tcode{subtract_with_carry_engine} object.}
 Sets the values of
 $X_{-r}, \dotsc, X_{-1}$,
...
\pnum
\changed{\requires}{\expects}
\tcode{n < size()} \added{is \tcode{true}}.
...
\pnum
\changed{\requires}{\expects}
\tcode{size() == v.size()} \added{is \tcode{true}}.
...
\pnum
\changed{\requires}{\expects}
\tcode{size() > 0} \added{is \tcode{true}}.
...
This function shall return a value of type \tcode{T}
or which can be unambiguously implicitly converted to type \tcode{T}.
\end{removedblock}
\end{itemdescr}
