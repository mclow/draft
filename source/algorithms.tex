...
\pnum
\changed{\requires}{\expects}
For the first form, type \tcode{T} \changed{shall be}{is}
...
For the first form, type \tcode{T} \changed{shall be}{is} \oldconcept{LessThanComparable}.
...
\changed{shall be}{is} \oldconcept{LessThan\-Comparable} (\tref{lessthancomparable}).
