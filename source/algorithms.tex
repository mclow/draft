...
The type \tcode{Size}
\changed{shall be}{is} convertible to \added{an} integral type~(\ref{conv.integral}, \ref{class.conv}).
...
\begin{removedblock}
\pnum
\requires The expression \tcode{*first = new_value} shall be valid.
\end{removedblock}

\begin{addedblock}
\pnum
\mandates \tcode{new_value} is writable\iref{iterator.requirements.general} to \tcode{first}.
\end{addedblock}
...
\begin{addedblock}
\pnum
\mandates \tcode{*first} is writable\iref{iterator.requirements.general} to \tcode{result}.
\end{addedblock}
...
\pnum
\mandates
\tcode{Distance} is an integer type.   \tcode{*first} is
...
\pnum
\ednote{The first sentence has been removed editorially outside of this paper.}
\changed{\requires}{\expects}
...
\pnum
\changed{\requires}{\expects}
For the first form, \removed{type} \tcode{T} \changed{shall be}{meets the}
...
For the first form, \removed{type} \tcode{T} \changed{shall be}{meets the} \oldconcept{LessThanComparable}
\begin{addedblock}
...
\item
  ...
  writable\iref{iterator.requirements.general} to \tcode{result}.
