...
\tcode{Function} \changed{shall satisfy}{satisfies}
...
\pnum
\changed{\requires}{\expects}
\tcode{Function} \changed{shall satisfy}{satisfies} the \oldconcept{CopyConstructible} requirements.
...
\pnum
\changed{\requires}{\expects}
\tcode{Function} \changed{shall satisfy}{satisfies} the \oldconcept{MoveConstructible} requirements
\begin{note}
...
\begin{itemize}
\item
  \tcode{PopulationIterator}'s value type is be
...
\begin{itemize}
\item
  \tcode{PopulationIterator} \changed{shall satisfy}{satisfies}
  the \oldconcept{InputIterator} requirements\iref{input.iterators}.
\item
  \tcode{SampleIterator} \changed{shall satisfy}{satisfies}
...
\pnum
\changed{\requires}{\expects}
The type of \tcode{*first} \changed{shall satisfy}{satisfies}
...
\pnum
\changed{\requires}{\expects}
\tcode{InputIterator}'s value type \changed{shall be}{is} constructible
from the type of \tcode{*first}.
The result of the
expression \tcode{std::move(acc) + *i} or \tcode{binary_op(std::move(acc), *i)}
\changed{shall be}{is} implicitly convertible to \tcode{InputIterator}'s value type.
...
\item
  For the overloads with no \tcode{ExecutionPolicy},
  \tcode{T} is constructible from the type of \tcode{*first}.
...
\item
  For the overloads with no \tcode{ExecutionPolicy},
  \tcode{T} \changed{shall be}{is} \oldconcept{MoveAssignable} (\tref{moveassignable}) \removed{and
