...
\tcode{a.insert(p,i,j)}    &
 ...
 \added{\effects} Inserts copies of elements in \tcode{[i, j)} before \tcode{p}  \\ \rowsep
...
\pnum
\changed{\requires}{\expects} \tcode{T} \changed{shall be}{is} \oldconcept{MoveInsertable} and \oldconcept{DefaultInsertable} into \tcode{*this}.
\end{itemdescr}
...
\added{%
\pnum
\expects \tcode{T} \changed{shall be}{is} \oldconcept{DefaultInsertable} into \tcode{*this}.
}
...
\removed{%
\pnum
\requires \tcode{T} \changed{shall be}{is} \oldconcept{DefaultInsertable} into \tcode{*this}.
}
\end{itemdescr}
...
\added{%
\pnum
\expects \tcode{T} \changed{shall be}{is} \oldconcept{CopyInsertable} into \tcode{*this}.
}
...
\removed{%
\pnum
\requires \tcode{T} \changed{shall be}{is} \oldconcept{CopyInsertable} into \tcode{*this}.
}
\end{itemdescr}
...
\added{%
\pnum
\expects \tcode{T} \changed{shall be}{is}
...
\removed{%
\pnum
\requires \tcode{T} \changed{shall be}{is}
\oldconcept{DefaultInsertable} into \tcode{*this}.
}
