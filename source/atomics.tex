...
\begin{itemdescr}
\pnum
\changed{\requires}{\expects} The \tcode{order} argument \changed{shall not be}{is not}
...
\begin{itemdescr}
\pnum
\changed{\requires}{\expects} The \tcode{failure} argument \changed{shall not be}{is not}
\tcode{memory_order_release} nor \tcode{memory_order_acq_rel}.
...
\begin{itemdescr}
\pnum
\changed{\requires}{\expects} The \tcode{order} argument \changed{shall not be}{is not} \tcode{memory_order::consume},
...
\begin{itemdescr}
\pnum
\changed{\requires}{\expects} The \tcode{order} argument \changed{shall not be}{is not} \tcode{memory_order::release} nor \tcode{memory_order::acq_rel}.
...
\begin{itemdescr}
\pnum
\changed{\requires}{\expects} The \tcode{failure} argument \changed{shall not be}{is not} \tcode{memory_order::release} nor
