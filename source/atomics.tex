...
\begin{itemdescr}
\pnum
\changed{\requires}{\mandates} \tcode{T} \changed{shall be}{is} an object type \removed{,
...
\begin{itemdescr}
\pnum
\changed{\requires}{\mandates} T \changed{shall be}{is} an object type \removed{, otherwise the program is ill-formed}.
