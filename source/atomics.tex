...
namespace std {
  ...
  public:
    ...
    void store(T, memory_order = @\added{memory_order::}@memory_order_seq_cst) const noexcept;
    T load(memory_order = @\added{memory_order::}@memory_order_seq_cst) const noexcept;
    T exchange(T, memory_order = @\added{memory_order::}@memory_order_seq_cst) const noexcept;
    bool compare_exchange_weak(T&, T,
                               memory_order, memory_order) const noexcept;
    bool compare_exchange_strong(T&, T,
                                 memory_order, memory_order) const noexcept;
    bool compare_exchange_weak(T&, T,
                               memory_order = @\added{memory_order::}@memory_order_seq_cst) const noexcept;
    bool compare_exchange_strong(T&, T,
                                 memory_order = @\added{memory_order::}@memory_order_seq_cst) const noexcept;
...
\pnum
\added{The program is ill-formed if \tcode{is_trivially_copyable_v<T>} is \tcode{false}.}
\removed{The template argument for \tcode{T} shall be trivially copyable\iref{basic.types}.}
...
\begin{itemdescr}
\pnum
\changed{\requires}{\expects} The referenced object \changed{shall be}{is} aligned to \tcode{required_alignment}.

\pnum
\removed{\effects Constructs an atomic reference that references the object.}
\added{\ensures \tcode{*this} references \tcode{obj}.}
...
\begin{itemdescr}
\pnum
\removed{\effects Constructs an atomic reference
that references the object referenced by \tcode{ref}.}
\added{\ensures \tcode{*this} references the object referenced by \tcode{ref}.}
\end{itemdescr}
...
\begin{itemdecl}
void store(T desired, memory_order order = @\added{memory_order::}@memory_order_seq_cst) const noexcept;
\end{itemdecl}

\begin{itemdescr}
\pnum
\changed{\requires}{\expects} The \tcode{order} argument \changed{shall not be}{is neither}
\tcode{\added{memory_order::}memory_order_consume},
\tcode{\added{memory_order::}memory_order_acquire}, nor
\tcode{\added{memory_order::}memory_order_acq_rel}.
...
\begin{itemdecl}
T load(memory_order order = @\added{memory_order::}@memory_order_seq_cst) const noexcept;
\end{itemdecl}

\begin{itemdescr}
\pnum
\changed{\requires}{\expects} The \tcode{order} argument \changed{shall not be}{is neither}
\tcode{\added{memory_order::}memory_order_release} nor \tcode{\added{memory_order::}memory_order_acq_rel}.
...
\begin{itemdecl}
T exchange(T desired, memory_order order = @\added{memory_order::}@memory_order_seq_cst) const noexcept;
\end{itemdecl}
...
bool compare_exchange_weak(T& expected, T desired,
                           memory_order order = @\added{memory_order::}@memory_order_seq_cst) const noexcept;
...
\begin{itemdescr}
\pnum
\changed{\requires}{\expects} The \tcode{failure} argument \changed{shall not be}{is neither}
\tcode{\added{memory_order::}memory_order_release} nor \tcode{\added{memory_order::}memory_order_acq_rel}.
...
except that a value of \tcode{\added{memory_order::}memory_order_acq_rel} shall be replaced by
the value \tcode{\added{memory_order::}memory_order_acquire} and
a value of \tcode{\added{memory_order::}memory_order_release} shall be replaced by
the value \tcode{\added{memory_order::}memory_order_relaxed}.
...
namespace std {
  ...
  public:
    ...
    bool is_lock_free() const noexcept;
    void store(@\placeholdernc{integral}@, memory_order = @\added{memory_order::}@memory_order_seq_cst) const noexcept;
    @\placeholdernc{integral}@ load(memory_order = @\added{memory_order::}@memory_order_seq_cst) const noexcept;
...
\begin{itemdecl}
@\placeholdernc{integral}@ fetch_@\placeholdernc{key}@(@\placeholdernc{integral}@ operand, memory_order order = @\added{memory_order::}@memory_order_seq_cst) const noexcept;
\end{itemdecl}
...
namespace std {
  ...
  public:
    ...
    bool is_lock_free() const noexcept;
    void store(@\placeholdernc{floating-point}@, memory_order = @\added{memory_order::}@memory_order_seq_cst) const noexcept;
    @\placeholder{floating-point}@ load(memory_order = @\added{memory_order::}@memory_order_seq_cst) const noexcept;
...
namespace std {
  ...
  public:
    ...
    T* fetch_add(difference_type, memory_order = @\added{memory_order::}@memory_order_seq_cst) const noexcept;
    T* fetch_sub(difference_type, memory_order = @\added{memory_order::}@memory_order_seq_cst) const noexcept;
...
\begin{itemdecl}
T* fetch_@\placeholdernc{key}@(difference_type operand, memory_order order = @\added{memory_order::}@memory_order_seq_cst) const noexcept;
\end{itemdecl}

\begin{itemdescr}
\pnum
\changed{\requires}{\mandates} \tcode{T} \changed{shall be an}{is a} \added{complete} object type \removed{,
...
\begin{itemdescr}
\pnum
\changed{\requires}{\expects} The \tcode{order} argument \changed{shall not be}{is neither} \tcode{memory_order::consume},
...
\begin{itemdescr}
\pnum
\changed{\requires}{\expects} The \tcode{order} argument \changed{shall not be}{is neither} \tcode{memory_order::release} nor \tcode{memory_order::acq_rel}.
...
\begin{itemdescr}
\pnum
\changed{\requires}{\expects} The \tcode{failure} argument \changed{shall not be}{is neither} \tcode{memory_order::release} nor
...
namespace std {
  template<> struct atomic<@\placeholder{floating-point}@> {
    ...
    bool is_lock_free() const volatile noexcept;
    bool is_lock_free() const noexcept;
    void store(@\placeholdernc{floating-point}@, memory_order = @\added{memory_order::}@memory_order_seq_cst) volatile noexcept;
    void store(@\placeholdernc{floating-point}@, memory_order = @\added{memory_order::}@memory_order_seq_cst) noexcept;
    @\placeholdernc{floating-point}@ load(memory_order = @\added{memory_order::}@memory_order_seq_cst) volatile noexcept;
    @\placeholdernc{floating-point}@ load(memory_order = @\added{memory_order::}@memory_order_seq_cst) noexcept;
    ...
    @\placeholdernc{floating-point}@ exchange(@\placeholdernc{floating-point}@,
                            memory_order = @\added{memory_order::}@memory_order_seq_cst) volatile noexcept;
    @\placeholdernc{floating-point}@ exchange(@\placeholdernc{floating-point}@,
                            memory_order = @\added{memory_order::}@memory_order_seq_cst) noexcept;
    bool compare_exchange_weak(@\placeholder{floating-point}@&, @\placeholdernc{floating-point}@,
                               memory_order, memory_order) volatile noexcept;
    bool compare_exchange_weak(@\placeholder{floating-point}@&, @\placeholdernc{floating-point}@,
                               memory_order, memory_order) noexcept;
...
\begin{itemdecl}
T A::fetch_@\placeholdernc{key}@(T operand, memory_order order = @\added{memory_order::}@memory_order_seq_cst) volatile noexcept;
T A::fetch_@\placeholdernc{key}@(T operand, memory_order order = @\added{memory_order::}@memory_order_seq_cst) noexcept;
\end{itemdecl}
...
\begin{itemdescr}
\pnum
\changed{\requires}{\mandates} T \changed{shall be an}{is a} \added{complete} object type \removed{, otherwise the program is ill-formed}.
...
\begin{addedblock}
\pnum
\expects This function is applied only
to objects that have been default constructed, and then only once.
\end{addedblock}

\pnum
\effects Non-atomically
initializes \tcode{*object} with value \tcode{desired}. \removed{This function shall only be applied
to objects that have been default constructed, and then only once.}
\begin{note}
These semantics ensure compatibility with C.
\end{note}
...
\begin{itemdescr}
\pnum
The macro \tcode{ATOMIC_FLAG_INIT} \changed{shall be}{is} defined in such a way that it can be used to initialize an object of type \tcode{atomic_flag} to the
