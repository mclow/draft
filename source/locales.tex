...
all possible specializations on parameters that \changed{satisfy}{meet} the
...
character types that \changed{satisfy}{meet}
...
\tcode{tbl} \added{is} either \changed{0}{nullptr} or \added{a pointer to} an array of at least
\tcode{table_size}
elements.
