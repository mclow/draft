...
\pnum
\constraints
\removed{The expression} \tcode{x + n} \changed{shall be valid}{is well-formed} and have type \tcode{Iterator}.
...
\pnum
\changed{\effects
Constructs a copy of \tcode{x}.}{\remarks}
...
\begin{itemdescr}
\pnum
\changed{\requires}{\expects} \tcode{in_stream != 0}.
